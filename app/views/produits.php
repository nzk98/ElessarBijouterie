            ...
            <div class="product-thumbnails">
                <?php foreach ($creation->getImages() as $index => $img): ?>
                    <div class="product-thumbnail">
                        <img src="<?php echo $img; ?>" alt="<?php echo htmlspecialchars($creation->getNom()); ?> - Vue <?php echo $index+1; ?>" class="thumbnail-img">
                    </div>
                <?php endforeach; ?>
            </div>
        </div>
        ...
        <div class="product-info">
            ...
            <div class="quantity-selector">
                ...
                <div class="quantity-controls">
                    <button type="button" class="quantity-btn minus" <?php echo ($creation->getStock() <= 0) ? 'disabled' : ''; ?>>-</button>
                    <span id="quantity-display">1</span>
                    <button type="button" class="quantity-btn plus" <?php echo ($creation->getStock() <= 0) ? 'disabled' : ''; ?>>+</button>
                </div>
            </div>
